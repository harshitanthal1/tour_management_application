    ...
    <div className="w-full flex justify-center">
      <div className="w-[90%] max-w-2xl rounded-xl shadow-xl p-3 flex flex-col gap-3">
        ...
        <div className="w-max flex flex-col">
          <img src={aboutImg} className="w-40 h-40" alt="Avatar" style="border-radius: 50%;" />
          <h1 className="text-xl font-semibold text-center">Harshit Anthal</h1>
        </div>
        <ul className="list-disc w-max mx-5">
          <li className="hover:underline hover:text-blue-600 cursor-pointer">
            <a
              className="flex items-center gap-2"
              href="https://github.com/harshitanthal1"
              target="_blank"
            >
          ...
          <li className="hover:underline hover:text-pink-600 cursor-pointer">
            <a
              className="flex items-center gap-2"
              href="https://www.instagram.com/harshitanthal1/"
              target="_blank"
            >
